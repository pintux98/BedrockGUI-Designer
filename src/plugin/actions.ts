...
export const ACTIONS: Record<ActionId, ActionDef> = {
  command: {
    ...
    capability: "always",
    body: "lines",
    hint: "Runs as the player, without a leading slash.",
    icon: "⌨️",
  ...
  open: {
    ...
    capability: "always",
    body: "lines",
    hint: "The form id from config.yml, or an addon form id.",
    icon: "📋",
  ...
  message: {
    ...
    capability: "always",
    body: "lines",
    hint: "Chat to the clicking player. 2048 characters maximum.",
    icon: "💬",
  ...
  delay: {
    ...
    capability: "always",
    body: "lines",
    hint: "Milliseconds, up to 30000. A second value chains one action.",
    icon: "⏱️",
  ...
  server: {
    ...
    body: "lines",
    hint: "Runs as console, bypassing player permissions.",
    icon: "🖥️",
  ...
  sound: {
    ...
    capability: "sound",
    body: "lines",
    hint: "name, name:volume, or name:volume:pitch.",
    icon: "🔊",
  ...
  title: {
    ...
    capability: "title",
    body: "lines",
    hint: "title:subtitle:fadeIn:stay:fadeOut, timings in ticks.",
    icon: "📜",
  ...
  conditional: {
    ...
    capability: "always",
    body: "conditional",
    hint: "check with true and false branches. Nests.",
    icon: "🔀",
  ...
  random: {
    ...
    capability: "always",
    body: "random",
    hint: "Picks one entry. Append @weight to bias it.",
    icon: "🎲",
  ...
  bungee: {
    ...
    capability: "always",
    body: "lines",
    hint: "A BungeeCord plugin message, subchannel first.",
    icon: "🔗",
